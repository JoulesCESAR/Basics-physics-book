...
\item Una auto viaja con MRU y debe llegar a su destino a las 8.00 PM. Si viajara a 120 km/h llegarı́a una hora después y si 
viajara a 160 km/h llegarı́a media hora antes. ¿A qué velocidad debe el auto viajar para que llegar a la hora indicada?.
\end{enumerate}
...
\begin{enumerate}
 ...
 $53^\circ$
. Despupess de que tiempo escuchará el estallido. Velocidad del sonido: 340m/s.
\end{enumerate}
